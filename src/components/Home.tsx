    ...
    <div className="bg-[#F5F2EC] text-[#525252] text-center pt-30">
      <div className="container mx-auto px-8 pb-5 md:px-16 lg:px-24">
        ...
        <p className="text-lg mx-auto text-left max-w-3xl text-gray-700">
          ...
          Waterloo with a passion for building impactful, user-focused software.
          I combine technical depth with a keen eye for design to craft
          responsive, high-quality web applications using React, TypeScript, and
          Node.js. My goal is to create digital experiences that are intuitive,
